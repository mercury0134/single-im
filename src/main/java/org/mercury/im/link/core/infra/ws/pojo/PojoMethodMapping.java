package org.mercury.im.link.core.infra.ws.pojo;
...
import org.mercury.im.link.core.infra.ws.exception.DeploymentException;
import org.mercury.im.link.core.infra.ws.support.*;
...
//        return implement;
        ...
        // Get the AutowireCapableBeanFactory from the application context
        AutowireCapableBeanFactory beanFactory = applicationContext.getAutowireCapableBeanFactory();

        // Perform dependency injection on the created instance
        beanFactory.autowireBean(implement);

        // Optionally initialize the bean (if needed)
        beanFactory.initializeBean(implement, pojoClazz.getName());
